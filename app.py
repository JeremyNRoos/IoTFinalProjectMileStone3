...
# Configuration - Load from config.json or environment variables (.env)
try:
...
AIO_USERNAME = (
    config.get('adafruit_io', {}).get('username')
    or os.environ.get('ADAFRUIT_IO_USERNAME')
    or os.environ.get('AIO_USERNAME')
    or 'YOUR_USERNAME'
)
AIO_KEY = (
    config.get('adafruit_io', {}).get('api_key')
    or os.environ.get('ADAFRUIT_IO_KEY')
    or os.environ.get('AIO_KEY')
    or 'YOUR_KEY'
)
...
# Feed names: use env if present, else fallback to username-based default
FEEDS = {
    'temperature': os.environ.get('ADAFRUIT_IO_FEED_TEMPERATURE', f'{AIO_USERNAME}/feeds/temperature'),
    'humidity': os.environ.get('ADAFRUIT_IO_FEED_HUMIDITY', f'{AIO_USERNAME}/feeds/humidity'),
    'motion': os.environ.get('ADAFRUIT_IO_FEED_MOTION', f'{AIO_USERNAME}/feeds/motion-state'),
    'light': os.environ.get('ADAFRUIT_IO_FEED_LIGHT', f'{AIO_USERNAME}/feeds/light-level'),
    'fan': os.environ.get('ADAFRUIT_IO_FEED_FAN', f'{AIO_USERNAME}/feeds/fan-toggle'),
    'mode': os.environ.get('ADAFRUIT_IO_FEED_MODE', f'{AIO_USERNAME}/feeds/system-mode'),
    'camera': os.environ.get('ADAFRUIT_IO_FEED_CAMERA', f'{AIO_USERNAME}/feeds/camera-last-image-timestamp'),
    'light_control': os.environ.get('ADAFRUIT_IO_FEED_LIGHT_CONTROL', f'{AIO_USERNAME}/feeds/light-toggle')
}
